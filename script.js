document.addEventListener('DOMContentLoaded', function() {
    ...
    // ================================================================
    // ============ KONFIGURASI BACKGROUND (TSPARTICLES) ==============
    // ================================================================
    // Efek: Rising Heat / Data Points
    // Warna: Biru (Cool) -> Putih -> Merah (Hot)
    tsParticles.load("tsparticles", {
        ...
        particles: {
            ...
            color: {
                value: ["#3b82f6", "#ffffff", "#ef4444"] // Palette Climate Stripes
            },
            shape: {
                type: "circle",
            },
            ...
            move: {
                enable: true,
                speed: 1,
                direction: "top", // Bergerak ke atas seperti panas/atmosfer
                random: true,
                straight: false,
                outModes: {
                    default: "out"
        ...
        },
{
        ...
        {
            title: "PART FOUR: What We’ve Done About It",
            original: [ 
...
{
            title: "4.1 ‘How can we undo our failures if we are unable to admit that we have failed?’",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.3 The Truth about Government Climate Targets",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.4 ‘We are not moving in the right direction’ / Greta Thunberg",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.5 The Persistence of Fossil Fuels",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.6 The Rise of Renewables",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.7 How Can Forests Help Us?",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.8 What about Geoengineering?",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.9 Drawdown Technologies",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.10 ‘A whole new way of thinking’ / Greta Thunberg",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.11 Our Imprint on the Land",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.12 The Calorie Question",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.13 Designing New Food Systems",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.14 Mapping Emissions in an Industrial World",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.15 The Technical Hitch",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.16 The Challenge of Transport",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.17 Is the Future Electric?",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.18 ‘They keep saying one thing while doing another’ / Greta Thunberg",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.19 The Cost of Consumerism",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.21 Waste around the World",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.22 The Myth of Recycling",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.23 ‘This is where we draw the line’ / Greta Thunberg",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "4.24 Emissions and Growth",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "PART FIVE: What We Must Do Now",
            original: [ 
...
{
            title: "5.1 ‘The most effective way to get out of this mess is to educate ourselves’",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.2 Individual Action, Social Transformation",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.3 Towards 1.5°C Lifestyles",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.4 Overcoming Climate Apathy",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.6 Remembering the Ocean",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.8 ‘We now have to do the seemingly impossible’ / Greta Thunberg",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.11 Changing the Media Narrative",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.12 Resisting the New Denialism",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.13 A Genuine Emergency Response",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.14 Lessons from the Pandemic",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.15 ‘Honesty, solidarity, integrity and climate justice’ / Greta Thunberg",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.17 What Does Equity Mean to You",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.18 Women and the Climate Crisis",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.19 Decarbonization Requires Redistribution",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.20 Climate Reparations",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.21 Mending Our Relationship with the Earth",
            type: 'sub-article',
            original: [
              ], 
            translation: [
...
{
            title: "5.22 ‘Hope is something you have to earn’ / Greta Thunberg",
            type: 'sub-article',
            original: [
              ], 
            translation: [
        ...
        },
{
    ...
    articlesData.forEach((articleData, articleIndex) => {
        ...
        // Icon panah disesuaikan agar lebih minimalis
        articleHeader.innerHTML = `<h3 class="">${articleData.title}</h3><div class="collapse-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg></div>`;
        ...
        textContainer.className = 'text-lg text-slate-300 font-normal'; // Font weight normal for cleanliness
        ...
        articleData.original.forEach((segment, segmentIndex) => {
            if (typeof segment === 'object' && segment !== null) {
                if (segment.type === 'image') {
                    ...
                    img.src = segment.src;
                    img.alt = segment.alt || 'Article Image';
                    img.className = 'w-full h-auto rounded-sm my-6 border border-slate-800'; // Styling image lebih tajam
    ...
    // ================================================================
    // ============== FUNGSI PREVIEW GAMBAR (TETAP AMAN) ==============
    // ================================================================
    ...
    function showPopup(target) {
        ...
        popup.innerHTML = `
            ...
            <button class="add-vocab-btn ${addedClass}" title="Bookmark Data" data-original="${originalSegment}" data-translation="${translationSegment}" data-article-index="${articleIndex}" data-segment-index="${segmentIndex}">
                ${buttonText}
            </button>
        `;
    ...
    function renderVocabulary() {
        ...
        if (vocabulary.length === 0) {
            vocabList.innerHTML = '<li class="empty-vocab-message">No Data Points Collected.</li>';
            return;
        }
    ...
    // MENGHAPUS LOGIKA AURORA LAMA (MOUSE MOVE)
    // agar tidak konflik dengan tsParticles
